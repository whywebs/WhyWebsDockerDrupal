...
postgres make import source="https://s3.amazonaws.com/whywebs-sample-files/postgres-import-test/export.zip"
postgres make import source="https://s3.amazonaws.com/whywebs-sample-files/postgres-import-test/export.tar.gz"
